 ...
 */
@JsonPropertyOrder({
  UpdateBotByIdResponse.JSON_PROPERTY_BOT,
  UpdateBotByIdResponse.JSON_PROPERTY_BOT_CALLBACK_URL,
  UpdateBotByIdResponse.JSON_PROPERTY_ENABLE_MARK_AS_READ,
  UpdateBotByIdResponse.JSON_PROPERTY_IS_PRIVACY_MODE,
  UpdateBotByIdResponse.JSON_PROPERTY_SHOW_MEMBER,
...
public class UpdateBotByIdResponse {
  ...
  **/
  ...
  /**
   * Return true if this updateBotByIdResponse object is equal to o.
   */
  @Override
