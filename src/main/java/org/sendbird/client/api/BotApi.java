...
public class BotApi {
   ...
   */
  public SendBirdMessageResponseV1 sendBotsMessageV1(String apiToken, String botUserid, SendBotSMessageData sendBotSMessageData) throws ApiException {
    return sendBotsMessageWithHttpInfoV1(apiToken, botUserid, sendBotSMessageData).getData();
  }
   ...
   */
  public ApiResponse<SendBirdMessageResponseV1> sendBotsMessageWithHttpInfoV1(String apiToken, String botUserid, SendBotSMessageData sendBotSMessageData) throws ApiException {
    Object localVarPostBody = sendBotSMessageData;
    ...
    GenericType<SendBirdMessageResponseV1> localVarReturnTypeV1 = new GenericType<SendBirdMessageResponseV1>() {};

    return apiClient.invokeAPI("BotApi.sendBotsMessageV1", localVarPath, "POST", localVarQueryParams, localVarPostBody,
            localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
            localVarAuthNames, localVarReturnTypeV1, false);
  }
  /**
   * Update a bot
